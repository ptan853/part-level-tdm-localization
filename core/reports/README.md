...
- `heldout_control_comparison_frozen_protocol.md`: the pre-run frozen protocol for the 60-case PartEdit-Bench synthetic-split comparison, including fixed methods, metrics, human evaluation, statistics, and success criteria.
